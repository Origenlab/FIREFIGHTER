...
La [NOM-002-STPS-2010](/blog/nom-002-stps-gabinetes-sistemas-portables) adopta criterios similares. En la práctica, el criterio más restrictivo entre la NOM y la NFPA es el que aplica cuando hay ambas en el expediente técnico.
...
Para verificar el cumplimiento normativo completo del sistema distribuido, incluyendo la [especificación correcta de cada gabinete](/blog/gabinetes-incendio-tipo-i-vs-tipo-ii) y el [kit de componentes](/blog/kit-completo-gabinete-contra-incendio) de cada punto, se requiere una auditoría sistemática que vaya más allá del plano.
...
1. **Obtener el plano actualizado de distribución de la planta** (layout de producción actual, no el de construcción original)
2. **Identificar todos los gabinetes existentes** y marcarlos en el plano con su ubicación real
3. **Medir distancias de recorrido** desde cada gabinete hasta los puntos de mayor riesgo, siguiendo rutas reales
4. **Identificar obstrucciones físicas**: cualquier elemento que bloquee el acceso al gabinete o el despliegue de la manguera
5. **Comparar contra criterios NFPA 14 / NOM-002-STPS**: ¿hay puntos a más de 30 metros de recorrido del gabinete más cercano?

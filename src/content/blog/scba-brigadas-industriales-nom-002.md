...
APF = 10 significa que si el ambiente tiene 10 ppm de H2S, el usuario respira 1 ppm.
APF = 10,000 significa que si el ambiente tiene 10,000 ppm, el usuario respira 1 ppm.
...
| Tipo de equipo | APF | Limitación principal |
|---|---|---|
| Semimáscara con filtro mecánico | 10 | Solo filtra partículas, no gases |
| Semimáscara con filtro combinado | 10 | APF bajo, no apto para IDLH |
| Máscara facial completa con filtro | 50 | No apto para atmósfera IDLH |
| Escape SCBA (uso único, salida) | 200 | Solo para evacuación, no para trabajo |
| SCBA de circuito abierto, circuito cerrado | 10,000 | Peso, tiempo de uso |
| Equipo de línea de aire + escape 5 min | 10,000 | Requiere fuente de aire externa |
...
Para comparar los modelos específicos de SCBA disponibles, consulta la [comparativa MSA G1 vs Scott AirPak 50](/blog/scott-airpak-50-vs-msa-g1-comparativa). Los requisitos normativos de certificación están en la [guía de NFPA 1970 para México](/blog/nfpa-1981-mexico-equipos-respiracion). El contexto completo de equipamiento de brigadas industriales está en la [guía de equipar brigadas industriales](/blog/equipar-brigada-industrial-mexico-guia). Los [SCBA y equipos de respiración disponibles](/productos/equipos-de-respiracion) incluyen opciones para cada perfil de riesgo industrial.

...
| Criterio | PASS separado | PASS integrado (SCBA) |
|---|---|---|
| Activación | Manual obligatoria | Automática al abrir cilindro |
| Riesgo de olvidar activar | Alto (documentado) | Eliminado |
| Batería independiente | Sí — mantenimiento adicional | No — sistema integrado |
| Costo adicional | $2,500–$5,000 MXN | Incluido en el SCBA |
| Confiabilidad operativa | Dependiente del usuario | Independiente del usuario |
| Compatible con SCBA moderno | Sí, como respaldo | Nativo |

...
Un bombero con traje certificado NFPA 1970 y botas de construcción sigue teniendo un sistema que falla. No porque el traje sea malo. Sino porque NFPA 1970 certifica un ensemble completo — el sistema en conjunto — y ese sistema funciona como sistema o no funciona.
...
## Qué certifica exactamente NFPA 1970: el ensemble, no las piezas

NFPA 1970 (Standard on Protective Ensembles for Structural Fire Fighting) certifica un ensemble completo. No certifica un traje. No certifica un casco. No certifica un guante.
...
El componente de mayor costo y mayor complejidad técnica. Tres capas funcionales, cada una con función específica, cuya interacción determina el TPP y THL del ensemble. El error más común: reemplazar solo una capa cuando se daña, sin verificar que la capa nueva es compatible con las otras dos en términos de certificación de ensemble. Ver nuestra [guía completa del traje de bombero Nomex](/blog/traje-bombero-nomex-guia-completa).

**2. Casco estructural certificado NFPA 1970**

No un casco industrial clase E. Un casco estructural diseñado para combate de incendio, con carcasa de resistencia térmica certificada, suspensión de 8 puntos, visera facial certificada y geometría compatible con máscara de SCBA y capucha Nomex. La [guía del Bullard USRHB](/blog/casco-bombero-bullard-usrhb-guia) detalla las diferencias críticas.
...
**4. Guantes estructurales NFPA 1970**
...
**5. Botas estructurales NFPA 1970**
...
El SCBA no es EPP en el sentido estricto de NFPA 1970 (cap. 5–9) — tiene su propia norma (NFPA 1970 (cap. 15–19)). Pero es parte integral del sistema operativo del bombero y su integración con la capucha y el casco determina la hermeticidad del ensemble en la zona facial.
...
| Casco estructural NFPA 1970 | $5,500–$8,000 | $9,000–$14,000 |
...
**Tercero:** casco estructural. No el industrial — el certificado NFPA 1970.
...
Lo que no es negociable en ningún escenario presupuestario: que cada componente que se adquiera tenga certificación NFPA 1970 de laboratorio acreditado, con edición específica de la norma. Un componente más barato pero certificado correctamente siempre es mejor que un componente más costoso sin certificación real.
...
- Casco de una edición de NFPA 1970 y traje de otra edición diferente

...
1. Retirar el detector de su base (la mayoría tienen sistema de giro de 1/4 de vuelta)
2. Inspección visual del exterior de la cámara por acumulación de polvo en las ranuras
3. Limpieza exterior de las ranuras con brocha suave (no aerosol de ningún tipo en este paso)
4. Si el fabricante lo permite para ese modelo: separar la tapa de la cámara y limpiar el interior con brocha suave en movimiento unidireccional (no circular)
5. Si el modelo no permite apertura de la cámara: usar aire comprimido de baja presión desde 30 cm de distancia, en ángulo de 45 grados respecto a las ranuras, no directamente adentro
6. Reinstalar y verificar que el LED de estado indica condición normal en el panel

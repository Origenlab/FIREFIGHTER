...
| Parámetro | Zona Convencional | Dirección SLC Individual (BG12LX) |
|---|---|---|
| Información en panel | "Zona 3 activó" | "Estación 47, piso 3, ala norte, escalera servicio" |
| Tiempo de localización | 5–15 min (recorrer todo el piso) | Directo al punto (menos de 2 min) |
| Supervisión de circuito | Falla de zona completa | Falla de dispositivo individual |
| Historial de activaciones | Por zona (no por estación) | Por estación individual con timestamp |
| Diagnóstico de accidentales | Difícil — zona con múltiples estaciones | Identificación exacta del punto problemático |
| Integración con protocolo | Respuesta a zona general | Respuesta específica por punto de activación |

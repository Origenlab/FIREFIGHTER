...
| Característica | Rosca NST/NH | Acople Storz |
|---|---|---|
| Tipo de conexión | Helicoidal (rosca) | Cuarto de vuelta (bayoneta) |
| Tiempo de conexión | 15-30 segundos | 2-4 segundos |
| Polaridad | Macho-hembra (un solo sentido) | Simétrico (cualquier orientación) |
| Compatibilidad entre marcas | Alta (si misma rosca y diámetro) | Alta (si mismo tamaño Storz) |
| Resistencia a contaminación | Sensible a daño en rosca | Más resistente a golpes |
| Peso por acople | Menor | Ligeramente mayor |
| Uso con guantes gruesos | Difícil a alta presión | Fácil |
| Presencia en bomberos CDMX | Parcial | Mayoritaria en modernos |
| Presencia en bomberos Monterrey | Alta (NST) | Creciente |
| Estándar en instalaciones nuevas | Predominante | En aumento |
...
Para entender cómo los acoples Storz se integran con las [válvulas angulares](/blog/valvulas-angulares-gabinetes-ci) y la manguera del sistema, consulte nuestra guía técnica de válvulas.
...
El estándar de conexión determina los componentes del gabinete. Un [kit completo de gabinete CI](/blog/kit-completo-gabinete-contra-incendio) debe especificar el tipo de rosca o acople en cada componente: la válvula angular, los extremos de la manguera y la lanza.

La selección del tipo de gabinete — Tipo I, II o III — también afecta qué conexiones son necesarias, como se explica en nuestra guía de [Gabinetes Tipo I vs Tipo II](/blog/gabinetes-incendio-tipo-i-vs-tipo-ii). Un Tipo III tiene dos salidas con estándares potencialmente diferentes: la de brigada (1.5" NST) y la de bomberos (2.5" Storz o NST según el cuerpo local).

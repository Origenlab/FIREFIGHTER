...
Responsable: el propio bombero usuario.
Frecuencia: antes y después de cada uso.
Alcance: inspección visual rápida de daños obvios que requieren retiro inmediato del servicio.
...
Responsable: el fabricante del equipo o un laboratorio certificado.
Frecuencia: cuando el Nivel 2 identifica condiciones que requieren evaluación de laboratorio, o por mandato del programa institucional.
Alcance: pruebas de laboratorio de las propiedades de desempeño del traje — TPP, THL, resistencia a la llama, integridad de la barrera de humedad mediante métodos instrumentales.

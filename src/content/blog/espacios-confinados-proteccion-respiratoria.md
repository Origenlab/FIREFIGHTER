...
- **Atmósfera inflamable:** concentración de vapores o gases combustibles entre el LEL (Lower Explosive Limit) y el UEL (Upper Explosive Limit). En esa ventana, una chispa o superficie caliente puede detonar la atmósfera.
...
1. **O2 primero.** Si hay deficiencia de oxígeno, cualquier otra medición es irrelevante porque el espacio no es seguro sin SCBA independientemente del resultado de los demás sensores.
2. **LEL.** Si hay concentración de gases inflamables entre 10% y 100% del LEL, el espacio tiene riesgo de explosión. Ningún equipo eléctrico sin certificación intrínsecamente seguro puede entrar.
3. **CO.** Comparar con el límite de exposición y el IDLH.
4. **H2S.** Ídem.

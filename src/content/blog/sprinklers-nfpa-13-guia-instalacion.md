...
Para el mantenimiento del sistema una vez instalado, NFPA 25 define las frecuencias de inspección y prueba. El artículo sobre [revisión anual de sistemas contra incendio](/blog/revision-anual-sistemas-contra-incendio) cubre el programa de mantenimiento completo. Las [bombas contra incendio](/blog/bombas-contra-incendio-nfpa-20-guia) son el componente de soporte crítico que el sistema de sprinklers necesita para funcionar a la presión y caudal de diseño.

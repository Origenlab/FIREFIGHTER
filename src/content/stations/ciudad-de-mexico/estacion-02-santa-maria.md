---
name: "Estación de Bomberos 02 Santa María la Ribera"
stationCode: "EB-CDMX-002"
...
La **Estación de Bomberos 02 Santa María la Ribera** es una de las unidades operativas más importantes del Heroico Cuerpo de Bomberos de la Ciudad de México. Ubicada estratégicamente en el corazón de la colonia Santa María la Ribera, esta estación brinda cobertura a una de las zonas con mayor densidad poblacional y actividad comercial del norte de la alcaldía Cuauhtémoc.

Fundada en **1922**, cuenta con más de un siglo de servicio ininterrumpido a la comunidad, consolidándose como un pilar fundamental en la protección civil y atención de emergencias de la zona centro-norte de la capital mexicana.

## Área de Cobertura Territorial

La Estación 02 tiene jurisdicción sobre un área aproximada de **12.5 km²**, atendiendo emergencias en las siguientes demarcaciones:
...
|--------|------|---------------------------|
| **Motobomba 02-A** | Autobomba Tipo I | Capacidad: 3,000 L / Bomba: 1,500 GPM / Mangueras: 300m |
| **Motobomba 02-B** | Autobomba Tipo II | Capacidad: 2,000 L / Bomba: 1,000 GPM / Escalera telescópica: 15m |
| **Ambulancia 02** | SVB | Soporte Vital Básico / Desfibrilador / Oxígeno medicinal |
| **Rescate 02** | Unidad Pesada | Equipo hidráulico Holmatro / Planta de luz / Generador |
...
Respuesta a incendios estructurales, vehiculares, forestales urbanos y en espacios confinados. El personal está capacitado en:
...
- Coordinación con hospitales: Hospital General de México, Hospital Rubén Leñero

### Rescate Vehicular y Extricación
Extracción de víctimas atrapadas en colisiones vehiculares:
- Estabilización de vehículos
- Corte de columnas y techos
- Desplazamiento de tableros
- Atención en vialidades principales: Eje 1 Norte, Av. Insurgentes, Circuito Interior

### Rescate Técnico en Alturas
- Rescate en edificaciones de hasta 8 niveles
- Extracción de personas atrapadas en elevadores
- Intervención en intentos de suicidio
- Rescate de trabajadores en andamios y estructuras
...
- Simulacros de evacuación en escuelas y oficinas
...
| Bombero de Línea | 10 | Combate directo de emergencias |
| Paramédico | 2 | Atención prehospitalaria |
| Operador de Unidad | 2 | Conducción de vehículos de emergencia |

## Tiempos de Respuesta Estimados

| Zona | Tiempo Promedio |
|------|-----------------|
| Área primaria (Santa María, San Rafael) | 3-5 minutos |
| Área secundaria (Guerrero, Tabacalera) | 5-7 minutos |
| Apoyo a estaciones vecinas | 8-12 minutos |

## Coordinación Institucional

La Estación 02 mantiene comunicación y coordinación permanente con:
